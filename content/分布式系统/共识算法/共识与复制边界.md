...
```mermaid
flowchart LR
  TXN[事务 UPDATE x=3] --> WAL[写 WAL 日志<br/>LSN 递增]
  WAL --> DATA[刷新数据页<br/>异步]
  WAL -->|流复制| STANDBY[备库 WAL Receiver<br/>回放 WAL]
```
