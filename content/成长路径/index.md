...
- [ ] **U-Boot 实操**：环境变量、`bootcmd`、加载 kernel/dtb/initramfs
...
### 1.15.2 第 2 季度 · 可观测与内核网络

- [ ] perf / ftrace 入门 + 一次真实卡顿案例
- [ ] 内核网络栈 vs DPDK 对比文
- [ ] 排障 SOP 定稿

### 1.15.3 第 3 季度 · 数据面项目化

- [ ] DPDK 小项目（多 worker + 统计）
- [ ] 性能剖析与绑核 checklist 实践

### 1.15.4 第 4 季度 · 产品化（二选一深入）
